...
class Tracker:
    ...
    def get_object_tracks(self, frames, read_from_stub=False, stub_path="stubs"):
        
        pickle_filename = "track_stubs.pkl"  # Or any suitable name for your pickle file
        pickle_filepath = os.path.join(stub_path, pickle_filename)
        
        if read_from_stub and os.path.exists(pickle_filepath):
    ...
    def draw_team_ball_control(self, frame, frame_num, team_ball_control, team_1_color, team_2_color):
    ...
    def draw_annotations(self, video_frames, tracks, team_ball_control, team_1_color, team_2_color):
        output_video_frames = []
